...
function groupDocTemplate_(kind, isLegal, byProxy, svcWord, vehTable) {
  ...
  return '<h2>ДОГОВОР № {{Номер договора}}</h2>' +
    ...
    '<p>2.3. Оплата производится в порядке, согласованном сторонами, в соответствии с законодательством Республики Беларусь.</p>' +
    '<h3>3. Гарантийные обязательства</h3>' +
    '<p>3.1. Срок гарантии на выполненные работы составляет {{Гарантия мес}} месяцев с даты подписания Акта при соблюдении правил эксплуатации. Гарантия на плёночное покрытие — 10 лет.</p>' +
    '<h3>4. Ответственность сторон и разрешение споров</h3>' +
    '<p>4.1. За неисполнение обязательств стороны несут ответственность в соответствии с законодательством Республики Беларусь. Споры разрешаются путём переговоров, а при недостижении согласия — в судебном порядке.</p>' +
    '<h3>5. Заключительные положения</h3>' +
    '<p>5.1. Договор составлен в двух экземплярах, имеющих одинаковую юридическую силу. Неотъемлемой частью договора является Акт сдачи-приёмки выполненных работ.</p>' +
    '<h3>6. Адреса, банковские реквизиты и подписи сторон</h3>' +
    '<table><tr>' +
